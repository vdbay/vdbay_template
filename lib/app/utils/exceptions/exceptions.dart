...
class VDBExceptions implements Exception {
  ...
  factory VDBExceptions.fromCode(String code) {
    switch (code) {
      case 'email-already-in-use':
        return const VDBExceptions(
      ...
      case 'user-not-found':
        return const VDBExceptions('Invalid login details. User not found.');
      case 'wrong-password':
        return const VDBExceptions(
      ...
      case 'invalid-password':
        return const VDBExceptions('Incorrect password. Please try again.');
      case 'invalid-phone-number':
        return const VDBExceptions('The provided phone number is invalid.');
      ...
      case 'sign_in_failed':
        return const VDBExceptions('Sign-in failed. Please try again.');
      case 'network-request-failed':
        return const VDBExceptions(
            'Network request failed. Please check your internet connection.');
      case 'internal-error':
        return const VDBExceptions('Internal error. Please try again later.');
      ...
      case 'quota-exceeded':
        return const VDBExceptions('Quota exceeded. Please try again later.');
      default:
        return const VDBExceptions();
    }
  }
